...
@section('content')
	<?php 
	$consCodeGet= (isset($_GET['cons_code']))? $_GET['cons_code'] : "";
	...
	<div class="container-widget">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('deo/pollPercentagetiming') }}">
		...
		<?php if(($consCodeGet!=="" && $polltimingGet!=="")  || ($encryptConsCode!=="" && $polltiming!=="")){ ?>
		<div class="row">
			<!-- Nominations -->
			<div class="col-md-12">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered tablefilter">
							...
							<tbody>									
								...
								?>
								<tr>
									<td><a href="{{ url('/deo/polling-percentage-detail') }}/{{eci_encrypt($pollpercentage->bid)}}">{{ $pollpercentage->poll_building }}</a></td>
									<?php
