...
?>
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('deo/consPollStationSub') }}">
									...
									<tbody>	
										...
										?>
											<tr>
												...
												<td>
													<a href="{{ url('/deo/supervisor-detail') }}/{{eci_encrypt($polling_station->supervisior_uid)}}">{{$polling_station->name}}</a>
												</td>
								...
								<table class="table table-bordered tablefilter1">
									...
									<tbody>	
										...
										?>
											<tr>
												<td>{{$polling_station->ps_id}}</td>
												<td><a href="{{ url('/deo/polling-detail') }}/{{eci_encrypt($polling_station->poll_booth_id)}}">{{$polling_station->poll_building}}</a></td>
												<td>{{$polling_station->cons_name}}</td>
												<!-- <td>{{$polling_station->poll_areas}}</td> -->
												<td>
													<a href="{{ url('/deo/supervisor-detail') }}/{{eci_encrypt($polling_station->supervisior_uid)}}">{{$polling_station->name}}</a>
