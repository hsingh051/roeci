...
?>
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('deo/poll-day') }}">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered tablefilter">
							...
							<tbody>									
								...
								?>
								<tr>
									<td><a href="{{ url('/deo/polling-detail') }}/{{eci_encrypt($pollDayDetails->poll_booth_id)}}">{{ $pollDayDetails->poll_building }}</a></td>
									<td>
										<?php
										...
										<?php
											if(!empty($mock_poll)){
												if($mock_poll->comment_status == 'yes'){
													...
													echo "<span style='color: #458B00;'>Done</br>Time: ".$mock_poll->activity_time.'</span>';
												}
											}
											else{
												echo "<span style='color: #FF0000;'>pending<span>";
