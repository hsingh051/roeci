	...
	<div class="container-widget">
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="searchBar">
						<form enctype="multipart/form-data" method="get" action="{{url('deo/search-evm-vvpat') }}">
							...
							<select class="form-control" name="cons_code">
								...
								?>
								<option value="{{$cons_code}}"<?php if($_GET['cons_code'] == $cons_code) echo"selected"; ?> >{{$Const->cons_name}}</option>
								@endforeach
							</select>
