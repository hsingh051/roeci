...
<body>
	...
	<div class="sidebar clearfix">
		<ul class="sidebar-panel nav">
			<li><a href="{{ url('/eci/dashboard') }}">Dashboard</a></li>
			<li><a href="{{ url('/eci/electoral-rolls') }}">Electoral Rolls</a></li>
			<li><a href="#">Teams</a></li>
			<li><a href="{{ url('/eci/nominations') }}">Nominations</a></li>
			<li><a href="{{ url('/eci/evm-vvpat') }}">EVM & VVPAT</a></li>
			<li><a href="#">Polling Staff</a></li>
			<li><a href="{{ url('/eci/training') }}">Training</a></li>
			<li><a href="{{ url('/eci/election-material') }}">Election Material</a></li>
			<li><a href="{{ url('/eci/polling-station') }}">Polling Stations</a></li>
			<li><a href="#">Pre-Poll Arrangement</a></li>
			<li><a href="#">Poll - 1 Day</a></li>
			<li><a href="{{ url('/eci/poll-day') }}">Poll Day</a></li>
