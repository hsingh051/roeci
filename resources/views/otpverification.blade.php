...
<div class="login-form">
	<form role="form" method="POST" action="{{ url('/verifyloginotp') }}" autocomplete="off">
		{{ csrf_field() }}
		<div class="top">
		...
		<div class="form-area">
			...
			<div class="group{{ $errors->has('otp') ? ' has-error' : '' }}">
				...
				<input id="otp" type="text" class="form-control" autocomplete="off" placeholder="Enter Your OTP" name="otp" value="{{ old('otp') }}" >
				<i class="fa fa-key"></i>
