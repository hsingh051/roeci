				...
				<div class="panel panel-widget">
					<div class="panel-title pageTitle titleBtn clearfix">
						...
						<div class="panel-btn formRightBtns">
							@if($polling_facility)
								<a href="{{url('eci/facilities') }}/{{ $bid }}" class="btn btn-default">facilities</a>
							@endif
							<a href="{{url('eci/booth-awareness-group') }}/{{ $bid }}" class="btn btn-default">Booth Awareness Group</a>
							<a href="{{url('eci/polling-parties-details') }}/{{ $bid }}" class="btn btn-default">Polling Party</a>
							<a href="{{url('eci/booth-photos') }}/{{ $bid }}" class="btn btn-default">Photos</a>
						</div>
					</div>
