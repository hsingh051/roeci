...
?>
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('eci/poll-day') }}">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered tablefilter">
							...
							<tbody>									
								...
								?>
								<tr>
									<td><a href="{{ url('/eci/polling-detail') }}/{{eci_encrypt($pollDayDetails->poll_booth_id)}}">{{ $pollDayDetails->poll_building }}</a></td>
									<td>
										<?php
