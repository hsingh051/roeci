...
@section('content')
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('eci/electionObserverSearch') }}">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="panel panel-widget heightWidget">
								@if(Session::has('obsSuccess'))
								<p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('obsSuccess') }}</p>
								@endif
								<div class="panel-title pageTitle titleBtn clearfix">
									<span>General Observers</span>
									<div class="panel-btn"><a href="{{ url('/eci/add-new-observer') }}" class="btn btn-default">Add New Observer</a></div>
								</div>
									...
									<table class="table table-bordered tablefilter">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="{{ url('/eci/observer-profile') }}<?php echo "/".eci_encrypt($value->id);?>">{{ $value->name }}</a></td>
												<td>{{ $value->phone }}</td>
											</tr>
											@endforeach
										</tbody>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="panel panel-widget heightWidget">
								...
								@endif
								<div class="panel-title pageTitle titleBtn clearfix">
									<span>Expenditure Observers</span>
									<div class="panel-btn"><a href="{{ url('/eci/add-new-observer') }}" class="btn btn-default">Add New Observer</a></div>
								</div>
								<div class="panel-body">
