			...
			<div class="col-md-12">
				<div class="panel panel-widget">
					<div class="panel-title pageTitle titleBtn clearfix">
						<span>POLLING STATION DETAIL</span>
						<div class="panel-btn formRightBtns">
							@if($polling_facility)
								<a href="{{url('ro/facilities') }}/{{ $bid }}" class="btn btn-default">facilities</a>
							@endif
							<a href="{{url('ro/booth-awareness-group') }}/{{ $bid }}" class="btn btn-default">Booth Awareness Group</a>
							<a href="{{url('ro/polling-parties-details') }}/{{ $bid }}" class="btn btn-default">Polling Party</a>
							<a href="{{url('ro/booth-photos') }}/{{ $bid }}" class="btn btn-default">Photos</a>
							<!-- <a href="{{ url('/ro/poll-day') }}" class="btn btn-default">Back</a> -->
						</div>
					</div>
