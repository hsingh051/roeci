					...
					<div class="col-md-12">
						<div class="panel panel-widget">
							<div class="panel-title pageTitle titleBtn clearfix">
								...
								<div class="panel-btn"><a href="{{ url('/ro/polling-stations-map') }}" class="btn btn-default">View Map</a></div>
							</div>
									...
									<tbody>	
										...
										@if($polling_station->poll_type == 'Notified')
											<tr>
												...
												<td>
													<a href="{{ url('/ro/polling-detail') }}/{{eci_encrypt($polling_station->poll_booth_id)}}">{{$polling_station->poll_building}}</a>
												</td>
								...
								<table class="table table-bordered tablefilter1">
									...
									<tbody>	
										...
										@if($polling_station->poll_type == 'Auxiliary')
											<tr>
												<td>{{$polling_station->ps_id}}</td>
												<td><a href="{{ url('/ro/polling-detail') }}/{{eci_encrypt($polling_station->poll_booth_id)}}">{{$polling_station->poll_building}}</a></td>												
												<td>{{$polling_station->name}}</td>
												<td>{{$polling_station->phone}}</td>
											</tr>
											@endif
