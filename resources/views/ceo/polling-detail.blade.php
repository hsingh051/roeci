				...
				<div class="panel panel-widget">
					<div class="panel-title pageTitle titleBtn clearfix">
						...
						<div class="panel-btn formRightBtns">
							@if($polling_facility)
								<a href="{{url('ceo/facilities') }}/{{ $bid }}" class="btn btn-default">facilities</a>
							@endif
							<a href="{{url('ceo/booth-awareness-group') }}/{{ $bid }}" class="btn btn-default">Booth Awareness Group</a>
							<a href="{{url('ceo/polling-parties-details') }}/{{ $bid }}" class="btn btn-default">Polling Party</a>
							<a href="{{url('ceo/booth-photos') }}/{{ $bid }}" class="btn btn-default">Photos</a>
						</div>
					</div>
