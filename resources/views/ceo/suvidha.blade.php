...
?>
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('ceo/suvidhaSub') }}">
					...
					<div class="panel-body">
						<table class="table table-bordered tablefilter">
							...
							@foreach ($getdata as $data)
								...
								<tr>
									<td>
									<a href="{{ url('/ceo/suvidha-detail') }}/{{eci_encrypt($data->ApplicationID)}}">{{ $data->Name }}</a>
									</td>
									<td>{{ $visitertype }}</td>
									<td>
