...
@section('content')
	...
	<div class="container-widget">  
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('ceo/candidate-list-search') }}">
						<input type="hidden" name="_token" value="<?= csrf_token(); ?>">
						<div class="form-group{{ $errors->has('dist_code') ? ' has-error' : '' }}">
							<select name="dist_code" class="form-control poll_dist_code_ceo" id="poll_dist_code_ceo" >
						...
						<div class="form-group{{ $errors->has('cons_code') ? ' has-error' : '' }}">
							<select name="cons_code" class="form-control poll_cons_code_ceo" id="cons_code">
					...
					<div class="panel-body">
						<ul class="candidateList clearfix">
							...
							<li>
								...
								?>
								<a href="{{url('ceo/candidate-affidavit') }}/{{$getNominations->cand_sl_no}}/{{$getNominations->cons_code}}" target="_blank">
