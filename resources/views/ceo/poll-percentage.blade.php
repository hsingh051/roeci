...
@section('content')
	...
	<div class="container-widget">
		<div class="row">
			<div class="col-md-12">
				<div class="searchBar">
					<form class="topSearchForm" enctype="multipart/form-data" method="get" action="{{url('ceo/pollPercentagetiming') }}">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="panel panel-widget">
					<div class="panel-title pageTitle">POLL PERCENTAGE REPORT</div>
					<div class="panel-body">
						...
						<table class="table table-bordered tablefilter">
							...
							<tbody>									
								...
								?>
								<tr>
									<td><a href="{{ url('/ceo/polling-percentage-detail') }}/{{eci_encrypt($pollpercentage->bid)}}">{{ $pollpercentage->poll_building }}</a></td>
									<?php
