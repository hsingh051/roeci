			...
			<div class="col-md-12">
				<div class="panel panel-widget">
					<div class="panel-title pageTitle titleBtn clearfix">
						<span>Political Parties: State Head</span>
						<div class="panel-btn"><a href="{{ url('/ceo/add-political-parties-state-head') }}" class="btn btn-default">Add New State Head</a></div>
					</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td><input type="text" class="form-control" placeholder="Search State Head Name" /></td>
									<td></td>
									<td></td>
									<td></td>
									<td></td>
